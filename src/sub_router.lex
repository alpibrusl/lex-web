...
fn route_effectful(r :: SubRouter, method :: Str, pattern :: Str, handler :: (ctx.Ctx) -> [io, time, random, sql, fs_read, fs_write, net, concurrent] resp.Response) -> SubRouter {
...
fn handler_json_effectful(r :: SubRouter, method :: Str, pattern :: Str, validator :: v.Validator, handler :: (ctx.Ctx) -> [io, time, random, sql, fs_read, fs_write, net, concurrent] resp.Response) -> SubRouter {
