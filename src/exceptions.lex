...
type Registry[E] = { matchers :: List[(E) -> Option[resp.Response]], fallback :: (E) -> resp.Response }
...
fn with_fallback[E](r :: Registry[E], fallback :: (E) -> resp.Response) -> Registry[E] {
  { matchers: r.matchers, fallback: fallback }
}

fn add[E](r :: Registry[E], matcher :: (E) -> Option[resp.Response]) -> Registry[E] {
...
fn handle_result[E, T](r :: Registry[E], result :: Result[T, E], to_response :: (T) -> resp.Response) -> resp.Response {
  match result {
    Ok(v) => to_response(v),
    Err(e) => handle(r, e),
  }
